...
public class Giris extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(!isBeforeStarted){
	        ...
	        alertDialog.setMessage("YÃ¼ksek SeÃ§im Kuruluâ€™nun verdiÄŸi karar uyarÄ±nca uygulama parti gÃ¶revlileri dÄ±ÅŸÄ±nda kullanÄ±ma kapatÄ±lmÄ±ÅŸtÄ±r!");
...
//		System.out.println("Datas was become: "+savedName+", "+shPreferences.getString(NAME, ""));
	...
	public void girisYap(){
		...
		try{
			...
			Toast.makeText(getApplicationContext(), "Hata oluÅŸtu; lÃ¼tfen bilgileriniz tekrar giriniz.", Toast.LENGTH_LONG).show();
		}
		*/
	}
