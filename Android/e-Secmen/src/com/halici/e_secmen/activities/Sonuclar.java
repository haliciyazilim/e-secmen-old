...
public class Sonuclar extends FragmentActivity implements TabHost.OnTabChangeListener, Serializable {
	...
	private void initialiseTabHost(Bundle args) {
        ...
        Sonuclar.addTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1").setIndicator("K�nye", getResources().getDrawable(R.drawable.icon_kisi_bilgisi)), ( tabInfo = new TabInfo("Tab1", SecmenKunye.class, args)));
